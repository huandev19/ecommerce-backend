...
Allow administrators to force-logout other users (both admin and customer users) by revoking all their active tokens. This is essential for security management such as terminating compromised sessions or enforcing access policies.
