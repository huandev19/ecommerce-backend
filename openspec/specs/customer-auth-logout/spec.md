...
Provide customer users with the ability to securely log out by revoking their current session tokens, and optionally revoke all active sessions across devices.
