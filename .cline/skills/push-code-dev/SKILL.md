---
name: push-code-dev
description: Push code lên nhánh dev với output rõ ràng, verbose. Kiểm tra branch, hiển thị danh sách commit sắp push, push lên origin/dev, và hiển thị kết quả chi tiết bằng tiếng Việt.
compatibility: Requires git to be installed, project initialized with git, and branch 'dev' to exist.
---

Push code lên nhánh `dev` với output rõ ràng, dễ đọc bằng tiếng Việt.
