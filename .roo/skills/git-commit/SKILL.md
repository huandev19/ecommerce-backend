---
name: git-commit
description: Commit code changes with a conventional commit message. Stages all changes, shows diff summary, and prompts for a commit message before committing.
compatibility: Requires git to be installed and initialized in the project.
---
